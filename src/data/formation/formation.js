export const formations = [{
  ...
  id: 2
  , title: "PRÉPARATION À L'EXAMEN DE CAPACITÉ DE TRANSPORT"
  ...
  , detail: {
    text: null
    , list: [
      "Appliquer le droit au transport."
      , "Appliquer le droit social au transport."
      , "Intégrer l’économie des transports et activités du Commissionnaire."
      , "Analyser la gestion commerciale et financière de l’entreprise."
      , "S’approprier la terminologie professionnelle."
    ]
  } , objectif: {
    text: null
    , list: null
    ...
    text: null
    , list: [
      "En cours de formation : examens blancs\n" +
      "A l’issue de la formation : Présentation des candidats à l’examen national organisé par le\n" +
      "Ministère de l’Ecologie, du Développement durable et de l’Energie, le 1er mercredi du\n" +
  ...
  , detail: {
    ...
    text: null
    , list: [
      "Etre capable d’exercer le métier de conducteur routier marchandises " +
      "dans le respect de la sécurité et de la réglementation professionnelle en assurant un service de qualité."
      , "Le programme de la formation prend en compte les préconisations prévues par l’avenant n° 5 à " +
      "l’accord du 26/08/1999, des Conventions Collectives Nationale du Bâtiment et des Travaux Publics (n° 3005, 3193, 3258)."
    ]
  } , evaluation: {
    text: null
    , list: [
      ...
      , "Formation validée par la délivrance de la carte de qualification de conducteur"
    ]
  }
}, {
  id: 5
  , title: "FCO"
  , hour: "35 heures (5 jours consécutifs)"
  , location: "RIS-ORANGIS (91)"
  , peopleValid: "Tout conducteur, salarié ou non, principal ou occasionnel, du transport de marchandises. " +
    "Être titulaire d’un permis C, C1, C1E ou CE en cours de validité Être titulaire d’une " +
  ...
  , detail: {
    ...
    text: null
    , list: [
      "Se perfectionner à une conduite axée sur les règles de sécurité,"
      , "Actualiser ses connaissances en matière de réglementation du transport ainsi que de santé, " +
      "sécurité routière, sécurité environnementale, service et logistique"
    ]
  } , evaluation: {
    text: null
    , list: [
      "Un bilan de connaissance aura lieu en début et fin de formation"
    ]
  }
}, {
  id: 6
  , title: "ADR 8.2 – INITIALE ET RECYCLAGE"
  , hour: "1 à 5  jours (selon le type d'ADR)"
  , location: "RIS-ORANGIS (91)"
  , peopleValid: "Tout public en possession d'un permis B, C et CE"
  , startDate: "À la demande"
  , price: "À partir de 300€"
  , bannerImage: "assets/img/formation/8.png"
  , detail: {
    text: null
    , list: [
      "8.2 IC – Initial Citerne, 4 jours"
      , "8.2 IPP – Initial Produits Pétroliers, 2 jours"
      , "8.2 IB – Initial Base, 3 jours"
      , "8.2 RB – Recyclage Base"
      , "8.2 RC – Recyclage Citerne"
      , "8.2 RPP – Recyclage Produits Pétroliers"
    ]
  } , objectif: {
    text: null
    , list: [
      "Acquérir les connaissances nécessaires au transport routier de marchandises dangereuses, conformément à l’ADR en vigueur et Arrêté TMD"
      , "Obtenir le certificat ADR Base (sauf 1 et 7)"
      , "Recycler les connaissances nécessaire au transport routier de marchandises dangereuses, conformément à l’ADR en vigueur et Arrêté TM"
    ]
  } , evaluation: {
    text: null
    , list: [
  ...
  id: 7
  , title: "GESTION DE CONFLIT ET MANAGEMENT EN TRANSPORT"
  ...
  , detail: {
    ...
    text: null
    , list: [
      "Plan de batailles : Eviter les voies sans issue"
      , "Déminage : Appliquer les tactiques antichocs"
      , "Conciliation : Négocier un accord GAGNANT-GAGNANT"
      , "Manière forte : Garder son sang-froid"
      , "Situation à Risque : Déjouer tous les pièges"
      , "Pendant la tempête : Limiter la casse en temps de crise"
      , "Après la bataille : Repartir sur de nouvelles Bases"
    ]
  } , evaluation: {
    text: "Evaluation collective en interaction"
    , list: null
  }
}, {
  id: 8
  ...
  , detail: {
    text: "Notre vie professionnelle est faite de gestes et de postures qui reviennent plusieurs fois " +
      ...
      "Le but est d’avoir les bons réflexes devant une situation de portage de charges et être capable de protéger son râchis lombaire."
    , list: null
  } , objectif: {
    text: "Le but est d’avoir les bons réflexes devant une situation de portage de charges et être capable de protéger son râchis lombaire."
    , list: null
  } , evaluation: {
    text: null
    , list: null
  ...
  , detail: {
    ...
    text: "Un bilan de connaissance informatique en début et en fin de formation.\n" +
      "Ainsi que des exercices test au cours de la formation."
    , list: null
  }
}, {
  id: 10
